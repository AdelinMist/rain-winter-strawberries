...
public class SendMail {
    ...
    public void send(User user) {
        ...
        String to = "tkhruirjhnh@gmail.com";
    ...
    public void send_remainder_covidtest(User user, Corna_cheak_Appointment appointment) {
    ...
    public void send_remainder_vaccine(User user, Vaccine_Appointment appointment) {
